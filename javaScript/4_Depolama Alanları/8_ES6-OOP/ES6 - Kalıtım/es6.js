...
// extends sayesinde belirtilen bütün özellikler geliyor
class Employee extends Person {  // DerivedClass, Subclass,ChildClass
  constructor(name, age, salary) {
    // this.name = name;
    // this.age = age;
    // super sayesinde bir üst sınıfda ki constructorı kullanabiliriz
    super(name, age);
    this.salary = salary;
  }
...
const emp = new Employee("esad", 25, 8000);
emp.raiseSalary(500);
